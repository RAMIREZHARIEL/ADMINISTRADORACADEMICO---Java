          ...
          <div class="col-lg-5">
            <div class="card bg-info shadow border-0">
              <div class="card-header bg-secondary pb-2">
                <div class="text-light text-center mb-6"><big>Registro </big></div>
                ...
                <form action="ServletUsuario" method="get">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Repita la Contraseña" type="password" name="txtRepiteContrasenia">
                    </div>
                  </div>
